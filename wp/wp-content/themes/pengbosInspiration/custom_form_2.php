    ...
    class my_custom_fields_2 {
        ...
        var $customFields = array(
            ...
            array(
                "name" => "phone_no",
                "title" => "Phone Numbuer",
                "description" => "Your contact phone numbuer which will be displayed in the Contact page",
                "scope" => array("page"),
                "capability" => "edit_post"
            ),
            array(
                "name" => "fax_no",
                "title" => "Fax Numbuer",
                "description" => "Your contact fax numbuer which will be displayed in the Contact page",
                "scope" => array("page"),
                "capability" => "edit_post"
            ),
            array(
